...
const HeroBanner = () => {
    ...
    const jobTitles = ["Front-End",  "Software Developer","Designer", "& Tech Nerd"];
  const [currentTitleIndex, setCurrentTitleIndex] = useState(0);
   useEffect(() => {
    const interval = setInterval(() => {
      setCurrentTitleIndex((prevIndex) => (prevIndex + 1) % jobTitles.length);
    }, 2000); // Change job title every 2 seconds (adjust the interval as needed)
                ...
                >
                    <h1 className="text-[50px] md:text-[120px] 2xl:text-[189px] leading-[50px] md:leading-[125px]  2xl:leading-[192px] font-oswald uppercase">
                        ...
                        <br className="invisible md:visible" />
                         <motion.span key={currentTitleIndex} style={{ display: 'inline-block' }}>
          {jobTitles[currentTitleIndex]}
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Aadil</span>
                    </div>
                    <div className="max-w-[510px]">
                         Computer Application Post Graduate from India, I am a Front-End Developer who is always eager to learn something new and is up to date on the latest trends in technology, space, and science 
                    </div>
                </motion.div>
                {/* INTRO END */}
                ...
                <motion.div
                    ...
                    transition={{ duration: 0.5 }}
                >
                  { /*    <img src={man} alt="" />*      after some time add rthe profile  pic /}
